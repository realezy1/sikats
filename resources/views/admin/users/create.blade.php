            ...
            <div class="custom-card p-4">
                ...
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="name" name="name" type="text" class="form-control form-control-lg fs-6 @error('name') is-invalid @enderror" value="{{ old('name') }}" required autofocus placeholder="Masukkan nama lengkap" />
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" name="email" type="email" class="form-control form-control-lg fs-6 @error('email') is-invalid @enderror" value="{{ old('email') }}" required placeholder="Masukkan email" />
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="position-relative">
                            <input id="password" name="password" type="password" class="form-control form-control-lg fs-6 pe-5 @error('password') is-invalid @enderror" required autocomplete="new-password" placeholder="Minimal 8 karakter" />
                    ...
                    <div class="mb-4">
                        ...
                        <select id="role_id" name="role_id" class="form-select form-select-lg fs-6 @error('role_id') is-invalid @enderror" required>
                            ...
                            <option value="3" {{ old('role_id') == 3 ? 'selected' : '' }}>Dapur</option>
                        </select>
                        @error('role_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <input id="mobile_number" name="mobile_number" type="text" class="form-control form-control-lg fs-6 @error('mobile_number') is-invalid @enderror" value="{{ old('mobile_number') }}" placeholder="Contoh: 08123456789" />
                        @error('mobile_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="address" name="address" rows="3" class="form-control form-control-lg fs-6 @error('address') is-invalid @enderror" placeholder="Masukkan alamat lengkap">{{ old('address') }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2 justify-content-end border-top pt-4">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4 fw-medium">
                            <i class="bi bi-check2 me-1"></i> Simpan Pegawai
                        </button>
                    </div>
                </form>
